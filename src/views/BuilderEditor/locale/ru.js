...
var _default = {
  ...
  panels: {
    buttons: {
      titles: {
        ...
        'open-sm': 'Диспетчер стилей',
        'open-tm': 'Настройки',
        'open-layers': 'Диспетчер слоев',
        'open-blocks': 'Блоки',
      },
    },
  },
  ...
  traitManager: {
    empty: 'Выберите элемент перед использованием менеджера параметров.',
  ...
  storageManager: {
    recover: 'Хотите восстановить несохраненные изменения?',
  },
};
