...
var traitInputAttr = {
  placeholder: 'напр. текст'
};
var _default = {
  assetManager: {
    addButton: 'Додати',
    inputPlh: 'http://path-to-image.jpg',
    modalTitle: 'Виберіть зображення',
    uploadTitle: 'Перетягніть файли сюди або натисніть, щоб завантажити',
  },
  ...
  panels: {
    buttons: {
      titles: {
        ...
        'sw-visibility': 'Переглянути компоненти',
        'export-template': 'Переглянути код',
        'open-sm': 'Менеджер стилів',
        'open-tm': 'Налаштування',
        'open-layers': 'Диспетчер шарів',
        'open-blocks': 'Блоки',
      },
    },
  },
  ...
  styleManager: {
    empty: 'Виберіть елемент перед використанням диспетчера стилів',
    layer: 'Layer',
    fileButton: 'Images',
    sectors: {
      general: 'Загальні',
  ...
  traitManager: {
    empty: 'Виберіть елемент для використання менеджера параметрів',
    label: 'Налаштування компонента',
    traits: {
      ...
      attributes: {
        ...
        href: {
          placeholder: 'напр. https://google.com',
        },
      },
      // In a trait like select, these are used to translate option names
      options: {
        target: {
          false: 'в поточному вікні',
          _blank: 'в новом окне',
        },
      },
    },
  ...
  storageManager: {
    recover: 'Бажаєте відновити незбережені зміни?',
  },
};
